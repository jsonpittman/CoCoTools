...
let BasicReplacements = {
    ...
    "FILES": String.fromCharCode(209),
    "VERIFY": String.fromCharCode(218),
    "PRESET": String.fromCharCode(190),
    "HGET": String.fromCharCode(235),
    "TAB\\(": String.fromCharCode(164),
    ...
    "UNLOAD": String.fromCharCode(219),
        ...
        for (let i = 0; i < parts.length; i++) {
            if (i % 2 === 0 && parts[i].length > 0 && remFound === false) {
                ...
                for (let qs = 0; qs < quoteSplit.length; qs++) {
                    if (!quoteSplit[qs].startsWith("DATA")) {
                        ...
                        quoteSplit[qs] = quoteSplit[qs].replace("DATA", String.fromCharCode(134));
                    }
                }
